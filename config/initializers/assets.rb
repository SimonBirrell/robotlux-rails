...
Rails.application.config.assets.precompile += %w( piluku/themify.ttf )
Rails.application.config.assets.precompile += %w( piluku/themify.svg )
Rails.application.config.assets.precompile += %w( piluku/themify.woff )
Rails.application.config.assets.precompile += %w( piluku/themify.eot )

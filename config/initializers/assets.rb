...
Rails.application.config.assets.precompile += %w( piluku/images/cbr.png )
Rails.application.config.assets.precompile += %w( piluku/ionicons.ttf )
Rails.application.config.assets.precompile += %w( piluku/ionicons.eot )
Rails.application.config.assets.precompile += %w( piluku/ionicons.woff )
Rails.application.config.assets.precompile += %w( piluku/ionicons.svg )
Rails.application.config.assets.precompile += %w( fonts/piluku/ionicons.ttf )
Rails.application.config.assets.precompile += %w( fonts/piluku/themify.ttf )
Rails.application.config.assets.precompile += %w( fonts/piluku/themify.svg )
Rails.application.config.assets.precompile += %w( fonts/piluku/themify.woff )
Rails.application.config.assets.precompile += %w( fonts/piluku/themify.eot )
